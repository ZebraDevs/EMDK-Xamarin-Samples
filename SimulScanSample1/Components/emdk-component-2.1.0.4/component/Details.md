...
* Supports Xamarin Studio 4.10 and greater (Windows and Mac)
...
- [Read the Visual Studio Setup Guide](http://emdk.github.io/xamarin-docs/2.0/#guide-vs-setup)
- [Read the Xamarin Studio Setup Guide](http://emdk.github.io/xamarin-docs/2.0/#guide-xs-setup)
...
- [Read the Using Xamarin Samples Guide](http://emdk.github.io/xamarin-docs/2.0/#guide-sample-about)
...
- [Read the Profile Manager Overview Guide](http://emdk.github.io/xamarin-docs/2.0/#guide-profiles-about)
...
- [Follow the Hello Xamarin tutorial](http://emdk.github.io/xamarin-docs/2.0/#guide-tutorial-helloxamarin)
...
- [Check our full online docs](http://emdk.github.io/xamarin-docs/2.0/)
